...
//print_r($_SESSION);
// $hash = sha1('insert_orden_pregunta_2019-11-18');
// echo '<br><br><br>insert_orden_pregunta : '. $hash. '<br>';
/* 781e41a4c6237dbaecab19579643041de310c041
echo generaPass();
$hash = sha1('insert_usuario_2019-11-06');
echo '<br><br><br>insert_usuario_nuevo : '. $hash. '<br>';


$hash = sha1('insert_answ_2019-04-07');
echo 'insert_answ : '. $hash. '<br>';

$hash = sha1('insert_estudiante_simulacro');
echo 'insert_estudiante_simulacro : '. $hash. '<br>';


$hash = sha1('delete_estudiante_simulacro');
echo 'delete_estudiante_simulacro : '. $hash. '<br>';
*/
//header("Content-type:application/json")
/*$hash = sha1('prom2001josdom');
echo 'select : '.$hash. '<br>';

$hash = sha1('select2019-02-11');
echo 'select : '.$hash. '<br>';
$hash = sha1('update2019-02-11');
echo 'update : '. $hash. '<br>';
$hash = sha1('delete2019-02-11');
echo 'delete : '. $hash. '<br>';
$hash = sha1('insert2019-02-11');
echo 'insert : '. $hash. '<br>';

$hash = sha1('sicae12345');
echo 'clave inicial sicae12345 : '. $hash. '</br>';
$hash = sha1('login2019-03-09');
echo 'login : '. $hash. '</br>';
$hash = sha1('verificarSesion2019-03-09');
echo 'verificarSesion : '. $hash. '</br>';
echo date("Ymdhms");
*/ 
   
//   $json ='{"action":"23929870008e23007350be74a708ab3a806dce13" } ';
...
foreach ($_POST as $clave => $valor){
 ...
 /*
$hash = sha1('generar_pdf_simulacros2020-enero-9');
echo 'generar_pdf_simulacros : '. $hash. '</br>';


$hash = sha1('obtener_resultados_simulacros2020-enero-9');
echo 'obtener_resultados_simulacros : '. $hash. '</br>';
