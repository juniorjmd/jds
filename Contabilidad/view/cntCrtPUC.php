...
<script src="view/js/cntCrtPUC.js" type="text/javascript"></script> 


<div class="panel panel-default" >  
    <div class="clearfix">
    <span class="float-left"><h3>&nbsp;&nbsp;&nbsp;Creación y edición subCuentas contables</h3></span>
</div>
              ...
              <tr>
                ...
                <div width="100%" align="center">
                    <div class="row" style="width:100%">
                        ...
                        <div class="col-md-3 col-sm-12"><div class="form-group">
                           ...
                           <div class="col-md-3 col-sm-12"><div class="form-group">
                            ...
                            <select  class="form-control" id="cod_cuentas">
                                <option value="">Ninguno</option>
                            </select>
                    ...
                    <div class="row" style="width:100%" id="tablaResultado">
                        ...
                        <?php echo cargarTablaLIstar('vw_cnt_scuentas',false,true);?>
                    </div>
