...
<script src="view/js/cntEstadoDeResultado.js" type="text/javascript"></script> 

<form name="formularioBalance" id="formularioBalance" method="POST">
    <input type="hidden" value="EXTRAER_ESTADO_DE_RESULTADO"  name="action">
...
<div id="contenedor"class="panel panel-default" >  
   ...
   <div class="row" style="width:100%"> <br>
            <div class="col-md-12 col-sm-12 text-center">
                ...
                <label>Estado de resultado</label>
            </div>   
    ...
    <div class="center" id="div_tabla_reporte">
        ...
        <tr><td align="center" colspan="3"><h1>ESTADO DE RESULTADO</h1></td></tr>
        
                <tr><td rowspan="2" valign="TOP">
                        <table style="width: 100%" border="1">
                            <tr><td colspan="2" align="center"><H3>INGRESOS</H3></td></tr>
                            <tbody id="tbActivo"></tbody>
                            <tr><td><h3>total ingresos</h3></td>
                            <td   id="tActivo"> </td></tr>
                        </table>
                    </td><td rowspan="2" valign="TOP" style="width:20px">&nbsp;</td>
            <td> <table style="width: 100%" border="1">
                            <tr><td colspan="2" align="center"><H3>GASTOS</H3></td></tr>
                            <tbody id="tbPasivo"></tbody>
                            <tr><td><h3>total gastos</h3></td>
                            <td   id="tPasivo"> </td></tr>
                        </table></td></tr>
        <tr><td><table style="width: 100%" border="1">
                            <tr><td colspan="2" align="center"><H3>COSTOS</H3></td></tr>
                            <tbody id="tbPatrimonio"></tbody>
                            <tr><td><h3>total costos</h3></td>
