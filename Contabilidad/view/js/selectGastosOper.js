    ...
    { 
      ...
      $('#enviar_seleccion').click(function(){
           ...
           $('input:checked').each(function() {
               formData += coma + $(this).val();
                coma = ',';    
});
        var message = ""; 
    var datosAjax = {action:'GUARDAR_DATOS_GASTOS_OPERATIVOS',
          DATOS : formData };        
      $.ajax({
      ...
      $('.cuenta').click(function(){
        ...
        var chequear =   $(this).find('.swiche').val()
        console.log(chequear)
          if (chequear == 'true'){chequear = 'false'; 
           $("[data-chcuenta='"+cuenta+"']").prop( "checked",true  )
          }else{chequear = 'true';
          
           $("[data-chcuenta='"+cuenta+"']").prop( "checked",false  )
          }
           $(this).find('.swiche').val(chequear)
         
      })
      $('#busqueda_cuenta').keyup(function(){
          ...
          if (Trim(busqueda) != ''){
              switch(tipobusqueda){
                case 'cuenta' ://data-cuenta='$cuenta'data-ncuenta
                  idbusqueda = '.cuenta'  ;
                  data1 = 'cuenta';
                  data2 = 'ncuenta';
                break;  
                case 'subcuenta' ://data-subcuenta=' {$row['nro_scuenta']}' data-nsubcuenta
                  idbusqueda = '.subcuentas'  ;
                  data1 = 'subcuenta';
                  data2 = 'nsubcuenta'; 
                  data3 = 'cuenta';  
                break;
              ...
              $('.subcuentas').hide()
                var dato1 = "";
                  var dato2 = "";
              $(idbusqueda).each(function(){
                
                  dato1 = String($(this).data(data1));
                  dato2 = $(this).data(data2);
                    
                  if( (dato1.indexOf(busqueda) != -1  ) || (dato2.indexOf(busqueda) != -1 )  ){
                
                  if(data3 != ''){
                      $('#cuenta_'+$(this).data(data3)).show()
                      $(this).show();
                  }else{
                      $('[data-cuenta="'+dato1+'"]').show();
                  }
