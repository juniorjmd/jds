...
<input type="hidden" value="<?php echo $_POST['datoHidden'];?>" id="IdCuentaHD"  />
<div id="cuerpoCuenta"  style="position: relative; left: 20px; top:3px;"  >
...
<table width="100%" height="292" border="0">
  <tr>
    ...
    <td width="19%"><div align="left">&nbsp;&nbsp;<span id="IdCuenta" class="cartera" ></span></div></td>
  ...
  <tr>
    <td colspan="6" align="right"><?php if ( $_POST['pagina_inicial']== '' || !isset($_POST['pagina_inicial'])){?>
  ...
  <tr>
    ...
    <td colspan="3"><div align="left">&nbsp;<span  class="cartera"  id="descripcion" ></span></div></td> <td colspan="2" rowspan="3" ><input title="Abonar" id="abonar" type="image" height="40" width="120"     src="imagenes/abonarBoton.png"/>      <input title="Liquidar" id="abonar2" type="image" height="40" width="120"   src="imagenes/liquidarBoton.png"/></td>
    </tr>
  <tr>
    <td colspan="4">&nbsp;</td>  
  </tr>
...
<div id="nuevoAbono" style=" padding:10Px;color: #ffffff; font-weight: bold;position:absolute; background-color:#006699;z-index: 5;left: 20%; top:200px; width:500px; height:280px">
...
<td>Tipo Pago</td><td>&nbsp;&nbsp;<select id="tipo_pago_abono"><option value="EFECTIVO">EFECTIVO</option>
                                           <option value="BANCOS">TRANSFERENCIA</option></select></td>
<tr>
    <td >Número Vauche</td><td>&nbsp;&nbsp;<input type="text" id="vauche_abono"/></td>
</tr>
<tr>
<td colspan="4">&nbsp;</td>
</tr>
