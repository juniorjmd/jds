...
<body><form action="estadoCuenta.php"  method="post" autocomplete="off" >
...
</form><a href="menuTrans.php" style="text-decoration:none"><input type="image" id="nuevoProv" src="imagenes/cancelar.jpg" height="50px" width="45"></a><a href="index.php" style="text-decoration:none"><input type="image" id="nuevoProv" src="imagenes/home_w.png" height="50px" ></a>
<div id="cuerpoCartera" width="100%">

<ul >
	<li><a id="Linktabs-1" href="#tabs-1">Cuentas Por Cobrar</a></li>	
    <li><a id="Linktabs-2" href="#tabs-2">Creacion De Cuentas Por Cobrar</a></li>
         ...
         ?> 
               <input   type="text" size="30%" class="busquedas" data-invoker="listadoModCartera" 
                      data-url_php="<?php echo URL_BASE."jds/php/db_listar.php"; ?>" /> <input type="hidden" id="respuesta" /><input type="hidden" id="gridID" />
...
<table width="94%" border="0">
 ...
 <tr class="ui-widget-header">
  ...
  <tr class="ui-widget-content">
    ...
    <td colspan="5"><div align="left">&nbsp;&nbsp;
      <input title="identificacion del cliente" class="busquedas NewCartera" data-invoker="nuevaCuenta" data-url_php="<?php echo URL_BASE."jds/php/db_listar.php"; ?>"  id="codigoCliente" type="number" />
 ...
 <tr>
    ...
    <td width="14%"><div align="right">Tipo de pagos </div></td>
...
<div style="display:none" width="100%"><div id="busquedaCliente"  width="100%" >
        <input id="busquedaPacienteRegistrado" class="busquedas" data-invoker="clientes_busqueda_nueva_cartera" data-url_php="<?php echo URL_BASE."jds/php/db_listar.php"; ?>" type="text" /> <input type="hidden" id="respuesta" /><input type="hidden" id="gridID" />
            <table border="0" id=" Tablacolor" width="100%"><tr><td>
             <table  border="0" id="listarTablaclientes" bordercolor="#71D8E3"  width="100%"    >
