...
$alert = '';
 ...
 if (isset($_POST['cerrar_remision']) && $_POST['cerrar_remision'] == 'cerrar_remision')
 {
    ...
    //$num_remision, $id_orden_compra
   $INPRESION = "<script type='text/javascript' >"
           ."window.open('".URL_BASE."/jds/printer_config/imprimir_remision.php?orden_de_compra={$id_orden_compra}&codigo_remision={$num_remision}','popup','width=600,height=500')"
           ."</script>";
    ...
    //$orden_de_compra,$codigo_remision;
     ...
     /*<input type="hidden" value="<?php  echo $id_orden_compra; ?>" name="id_orden_compra" />
                                <input type="hidden" value="<?php  echo $id_orden_compra; ?>" name="cerrar_remision" />
...
if ($num_datos >= 1)
{
    ...
    $query_cod_remision = " SELECT ifnull(max(num_remision),0) as cod_remision_actual FROM ".
            " remision_cabeza where orden_de_compra =  '{$_POST['id_orden_compra']}' " ;
...
if (isset($_POST['ingreso_solicitud'])  )
{
  ...
  if ($alert == ''){
      header("Location: crear_remision.php?num_orden_compra_aux={$_POST['id_orden_compra']}");
  }
}

$query_orden_compra = "select * from remision_detalle where id_remision = '{$num_remision}' and id_orden_compra = '{$id_orden_compra}'";
...
if ($num_datos >= 1)
{
 while ($row = $result->fetch_assoc()) {
	...
	$TABLA .= '<tr>' ; 
        ...
        $TABLA .="<td><img src='../imagenes/equis_naranja.gif' height='15' class='listaInv' id='".$row["id_remision_detalle"]."'></td>";
...
<script src="js/crear_remision.js" type="text/javascript"></script> 
</head>
        ...
        <div class="row" style="width:100%">  
            ...
            <div class="col-md-4 col-sm-11">
               ...
               <div class="row" style="width:100%"> 
                    ...
                    <div class="col-md-2 col-sm-11">
                       <label for="email" style="font-size: 11px;">Cod. producto :</label>
                       <input type="text" id="codProduto" class="remision form-control" name="codigo_del_producto"    >
                    </div><div class="col-md-1 col-sm-11">
                        <table><tr><td>
                       <input type="image" src="../buscar.png" id="buscarProducto" title="Buscar Producto" align="middle"style="" >
                       
                            <a href="../CreaProductos.php?llamado=145632jlhsue&AUX=1" style="text-decoration:none" id="AnuevoArt">
                        <img src="../iconoproducto.png" name="nuevoArt" width="26" height="22"  border="0" align="middle" id="nuevoArt" 
                             title="Crear Nuevo Producto"></a></td></tr></table>
            </div>
                    
                   
                   <div class="col-md-4 col-sm-11">
                        <label for="email" style="font-size: 11px;">Descripcion :</label>
                        <input type="text" id="InombreP" class="remision form-control" name="nombre_producto" readonly=""  >
                   </div> 
                    <div class="col-md-2 col-sm-11">
                        <label for="email" style="font-size: 11px;">Cantidad :</label>
                        <input type="text" id="cantidad_producto" class="compra form-control" name="cantidad_producto"    >                        
                        <input type="hidden" id="cantidad_producto_real" class="remision form-control" name="cantidad_producto_real"    >
                   </div> 
                 
                   
                   <div class="col-md-2 col-sm-11">
                        <label for="email" style="font-size: 11px;">Precio :</label>
                        <input type="text" id="Presio_sin_iva_producto" class="remision form-control" name="Presio_sin_iva_producto" >
                   </div>
                   <div class="col-md-2 col-sm-11">
                        <label for="email" style="font-size: 11px;">Iva :</label>
                        <input type="text" id="iva_producto" class="remision form-control" readonly="" name="iva_producto" >
                   </div>
                     <div class="col-md-2 col-sm-11">
                        <label for="email" style="font-size: 11px;">total :</label>
                        
                        <input type="text" id="Presio_producto" class="remision form-control" readonly=""  name="presio_producto" >
                   </div>
                   <div class="col-md-2 col-sm-11">
                        <label for="email" style="font-size: 11px;">total importe :</label>
                        <input type="text" id="total_remision" readonly="" class="remision form-control" name="total_remision" >
                        <input type="hidden" id="ingreso_solicitud" readonly="" class="remision form-control" name="ingreso_solicitud" >
                        <input type="hidden" id="porcent_iva" value=0 class="remision form-control" name="porcent_iva" >
                ...
                <div class="row" style="width:100% ; margin-top: 10px ;margin-bottom:  10px"> 
                   <div class="col-md-12 col-sm-11 text-center">
                       <button id="enviar_datos" type="button" class="btn btn-success">Ingresar</button>&nbsp;&nbsp;&nbsp;
                       <button id="limpiar_campos" type="button" class="btn btn-danger">Limpiar</button>&nbsp;&nbsp;&nbsp;
                        
                       <button  type="button" class="btn btn-primary" id="cerrar_remision">Cerrar</button>
                </div></div>
                <div class="row" style="width:100%"> 
