...
class printerNPOSctr {
	...
	public function getcontenido($VentaId, $idConfig )
		{	 try{
                     ...
                     $arr_id_remision = explode("_", $VentaId);
			...
			$query = "select a.* , ifnull(b.nombre1,'n/a')as nombre ,d.email, ifnull(b.apellido1,'n/a')as apellido , d.razonSocial ,".
                        ...
                        "ifnull(c.detalle,'')as detalle_orden_compra  ,".
                        ...
                        "inner join clientes d on  d.nit COLLATE utf8_general_ci = c.id_cliente COLLATE utf8_general_ci  ". 
                        "where num_remision = {$arr_id_remision[1]}".
                        " and orden_de_compra = {$arr_id_remision[0]}";
			...
			while ($row = $result->fetch_assoc()) {
                            /*id_remision, orden_de_compra, cantidadVendida, valorParcial, descuento, valorIVA, valorTotal, fecha, hora, 
                             * usuario, estado_remision, idVenta, fecha_entrega, dir_factura, nombre, email, apellido, razonSocial, nit, 
                             * direccion, telefono, fecha_de_entrega, cod_orden_externa*/
                                        
				$ARRAY['factura_actual']= $row["id_remision"]; 
				...
				$ARRAY['nit'] = $row['nit'] ;
                                ...
                                $ARRAY['detalle_orden_compra'] = trim($row['detalle_orden_compra']); 
			...
			$query = "select nombreProducto, presioSinIva, IVA ,cantidadVendida, valorTotal  ".
                                "from remision_detalle  where id_orden_compra = '{$arr_id_remision[0]}' and  id_remision =  '{$arr_id_remision[1]}';";
