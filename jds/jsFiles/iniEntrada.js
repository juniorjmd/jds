$(document).ready(function(){
    ...
    OcultaYMuestra("#transformar","");
    query ="SELECT * FROM "+$("#sucursalId").val()+"entradastemp" ;
    ...
    procesa_leave(id_input,"codigo","articulo",respuestaBusquedaArticulo,"grupo",$("#sucursalId").val());
    ...
    if($("#PresioVenta").val()==0){
        ...
        $("#guardarPresio").click(function(){
            if($("#PresioVenta").val()==0){alert("El Presio de venta debe ser mayor a 0");}	
