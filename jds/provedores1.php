...
<div id="container"  >
  <div id="menu" ><?php 
	   ...
	   ?>
	   Buscar
      <input name="text" type="text" class="busquedas" width="400" data-invoker='proveedores' /><a href="" onclick="algo();">
			...
			$("#EditarBoton").attr('src', 'imagenes/ui-icons_lapizNEGRO.png');
			  ...
			  $("#saveNew").click(function(){
				var query="INSERT INTO `proveedores` VALUES (?,?,?,?,?,?,?)";
				 datosJson=recogerDatos(".respuesta")+ "respuesta="+ encodeURIComponent("nuevoCli")+"&query="+ encodeURIComponent(query)+"&nocache=" + Math.random();;
				//alert(datosJson)
