...
<div  >
   <div class="row">
       <div class="col-md-12 col-sm-12">
           <h2>CONSULTAR MOVIMIENTO DE PROVEEDORES </h2>
           <hr>
       </div>
   </div> 
...
$id_tabla= 'tabla_resultados';
                $nombreArchivo= 'listaCuentasPorPagar';
                $tipoTabla = 1;
  ...
  <tr>
    ...
    <td nowrap><?php echo amoneda($abonoInicial); ?></td>
	 ...
	 <td nowrap><?php echo amoneda($TotalActual); ?></td>
	     <td><a  href="resumenDeCuentasPersonas.php?<?=$auxEnvio;?>&tabla1=<?php echo "proveedores"; ?>&origen_peticion=ver_reporte_cxp.php&idCliente=<?php echo $idCliente; ?>&tabla2=<?php echo "credito"; ?>&dir=<?php echo "estadoCredito.php"; ?>"><img src="imagenes/verdetalles.jpeg" width="28" height="25" border="0" title="Ver detalles"></a>	</td> 
	 </td> 
